...
<aui:script use="aui-event-input,aui-tabview,aui-url,liferay-history-manager,io-form">
	function inDialog() {
	...
	function revealSection() {
		...
		if (inDialog()) {
			...
			if (!currentLocationHash) {
				currentLocationHash = Liferay.HistoryManager.get('<portlet:namespace />historyKey');
			}
		}
