		...
		var DocumentLibrary = A.Component.create(
			{
				...
				prototype: {
					...
					_setSearchResults: function(content) {
						...
						var repositoryId = instance.one('#' + instance.ns('repositoryId'), content).val();

						var repositoryData = instance._repositoriesData[repositoryId];

						if (repositoryData) {
							var searchType = repositoryData.dataRequest[instance.NS + 'searchType'];
						}
						...
						if (fragmentSearchResults) {
							...
							if (multipleSearchResults) {
								...
								var singleSearchResults = entriesContainer.one('#' + instance.ns('singleSearchResults'));
						...
						var singleSearchResults = instance.one('#' + instance.ns('singleSearchResults'), content);
