									...
									<c:when test="<%= group != null %>">
										...
										<c:choose>
											<c:when test="<%= (publicLayoutSetPrototype != null) && !liveGroup.isStaged() && hasUnlinkLayoutSetPrototypePermission %>">
												...
												<div class='<%= publicLayoutSetPrototypeLinkEnabled ? "" : "aui-hide" %>' id="<portlet:namespace/>publicLayoutSetPrototypeMergeAlert">
									...
									<c:when test="<%= group != null %>">
										...
										<c:choose>
											<c:when test="<%= (privateLayoutSetPrototype != null) && !liveGroup.isStaged() && hasUnlinkLayoutSetPrototypePermission %>">
												...
												<div class='<%= privateLayoutSetPrototypeLinkEnabled ? "" : "aui-hide" %>' id="<portlet:namespace/>privateLayoutSetPrototypeMergeAlert">
