...
<c:choose>
	<c:when test="<%= viewEntries %>">
		<div id="<portlet:namespace />entries">
			...
			<liferay-ui:panel collapsible="<%= false %>" cssClass="aui-clearfix lfr-component panel-page-category recent" extended="<%= true %>" id="manageRecentPanel" persistState="<%= true %>" title="<%= panelTitle %>">
