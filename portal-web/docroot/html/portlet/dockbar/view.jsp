		...
		<c:if test="<%= !group.isControlPanel() && (themeDisplay.isShowLayoutTemplatesIcon() || themeDisplay.isShowPageSettingsIcon()) %>">
			<aui:nav-item anchorCssClass="manage-content-link" dropdown="<%= true %>" iconClass="icon-edit" id="manageContent" label="edit">
				...
				<c:if test="<%= themeDisplay.isShowPageSettingsIcon() %>">
					<aui:nav-item cssClass='<%= "first manage-page" + useDialogFullDialog %>' href='<%= themeDisplay.getURLPageSettings().toString() + "#_" + PortletKeys.LAYOUTS_ADMIN + "_tab=_" + PortletKeys.LAYOUTS_ADMIN + "_details" %>' label="page" title="manage-page" />
				</c:if>

				<c:if test="<%= themeDisplay.isShowLayoutTemplatesIcon() %>">
					<aui:nav-item cssClass='<%= "page-layout" + useDialogFullDialog %>' href='<%= themeDisplay.getURLPageSettings().toString() + "#_" + PortletKeys.LAYOUTS_ADMIN + "_tab=_" + PortletKeys.LAYOUTS_ADMIN + "_layout" %>' label="page-layout" title="manage-page" />
				</c:if>
