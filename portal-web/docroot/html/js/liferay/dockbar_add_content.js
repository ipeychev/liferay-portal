AUI.add(
	...
	'',
	{
		requires: ['aui-dialog', 'aui-io-request', 'aui-tooltip', 'autocomplete-base', 'autocomplete-filters', 'dd', 'event-mouseenter', 'liferay-dockbar', 'liferay-dockbar-add-content-drag-drop', 'liferay-dockbar-add-content-preview', 'liferay-dockbar-add-content-search', 'liferay-layout', 'liferay-portlet-base']
	}
);