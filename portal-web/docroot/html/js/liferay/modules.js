;(function(A, Liferay) {
	...
	var createLiferayModules = function() {
		...
		var moduleList = {
			'app-view-dd': ['aui-base', 'dd-constrain', 'dd-delegate', 'dd-drag', 'dd-drop', 'dd-proxy', 'liferay-history-manager', 'liferay-portlet-base', 'liferay-util-list-fields'],
			'app-view-folders': ['aui-base'],
			'app-view-paginator': ['aui-paginator', 'aui-parse-content', 'liferay-history-manager', 'liferay-portlet-base'],
			'app-view-select': ['aui-base', 'liferay-app-view-dd-navigation', 'liferay-history-manager', 'liferay-portlet-base', 'liferay-util-list-fields'],
