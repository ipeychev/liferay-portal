...
package com.liferay.content.composer.rest.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("Composition")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Composition")
public class Composition implements Serializable {

	public static Composition toDTO(String json) {
		return ObjectMapperUtil.readValue(Composition.class, json);
	}

	public static Composition unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Composition.class, json);
	}
	...
	public String getChatExternalReferenceCode() {
		if (_chatExternalReferenceCodeSupplier != null) {
			chatExternalReferenceCode =
				_chatExternalReferenceCodeSupplier.get();

			_chatExternalReferenceCodeSupplier = null;
		}
	...
	public void setChatExternalReferenceCode(
		...
		_chatExternalReferenceCodeSupplier = () -> {
			try {
				return chatExternalReferenceCodeUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _chatExternalReferenceCodeSupplier;
	...
	public String toString() {
		...
		String chatExternalReferenceCode = getChatExternalReferenceCode();

		if (chatExternalReferenceCode != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(chatExternalReferenceCode));
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.content.composer.rest.dto.v1_0.Composition",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:551666307