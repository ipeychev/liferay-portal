...
package com.liferay.ai.hub.cell.web.internal.application.list;
...
public class ContentSiteGeneratorPanelApp extends BasePanelApp {
	...
	public String getPortletId() {
		return AIHubCellPortletKeys.CONTENT_SITE_GENERATOR;
	}
	...
	@Reference(
		target = "(jakarta.portlet.name=" + AIHubCellPortletKeys.CONTENT_SITE_GENERATOR + ")"
	)
