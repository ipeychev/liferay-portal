...
public class LiferayVideoConverter extends LiferayConverter {
	...
	protected void prepareVideo(
		...
		outputIStreamCoder.setFrameRate(_frameRate);
		outputIStreamCoder.setPixelType(Type.YUV420P);
		outputIStreamCoder.setTimeBase(_timeBase);
	...
	private static IRational _frameRate = IRational.make(30, 1);

	private static IRational _timeBase = IRational.make(
		_frameRate.getDenominator(), _frameRate.getNumerator());
