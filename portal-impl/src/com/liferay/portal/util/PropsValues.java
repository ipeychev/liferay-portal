...
public class PropsValues {
	...
	public static final int DL_FILE_ENTRY_PREVIEW_VIDEO_THUMBNAIL_PERCENTAGE = GetterUtil.getInteger(PropsUtil.get(PropsKeys.DL_FILE_ENTRY_PREVIEW_VIDEO_THUMBNAIL_PERCENTAGE));
